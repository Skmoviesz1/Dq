...
# Bot information
SESSION = environ.get('SESSION', 'Skmovies')
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002438126233 -1002482493549 -1002427896229').split() if id_pattern.search(auth_channel)]
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002358397467')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Sk_supportgroup')
